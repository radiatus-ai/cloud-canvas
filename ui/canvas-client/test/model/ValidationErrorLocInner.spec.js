...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new CanvasApi.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function () {
    it('should create an instance of ValidationErrorLocInner', function () {
      ...
      //var instance = new CanvasApi.ValidationErrorLocInner();
      //expect(instance).to.be.a(CanvasApi.ValidationErrorLocInner);
    });
  });
});
