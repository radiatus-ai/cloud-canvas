...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.ValidationErrorLocInner();
  });
  ...
  describe('ValidationErrorLocInner', function() {
    it('should create an instance of ValidationErrorLocInner', function() {
      ...
      //var instance = new PlatformApi.ValidationErrorLocInner();
      //expect(instance).to.be.a(PlatformApi.ValidationErrorLocInner);
    });
