...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.ProjectCreate();
  });
  ...
  describe('ProjectCreate', function() {
    it('should create an instance of ProjectCreate', function() {
      ...
      //var instance = new PlatformApi.ProjectCreate();
      //expect(instance).to.be.a(PlatformApi.ProjectCreate);
    });
    ...
    it('should have the property isUserDefault (base name: "is_user_default")', function() {
      // uncomment below and update the code to test the property isUserDefault
      //var instance = new PlatformApi.ProjectCreate();
      //expect(instance).to.be();
    });
