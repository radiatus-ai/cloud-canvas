...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PlatformApi.PackageUpdate();
  });
  ...
  describe('PackageUpdate', function() {
    it('should create an instance of PackageUpdate', function() {
      // uncomment below and update the code to test PackageUpdate
      //var instance = new PlatformApi.PackageUpdate();
      //expect(instance).to.be.a(PlatformApi.PackageUpdate);
    });
