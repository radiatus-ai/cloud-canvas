    ...
    */
    ...
    createGlobalPackagePackagesPost(packageCreate, callback) {
      ...
      if (packageCreate === undefined || packageCreate === null) {
        throw new Error("Missing the required parameter 'packageCreate' when calling createGlobalPackagePackagesPost");
      }
    ...
    getCredentialCredentialsCredentialIdGet(credentialId, callback) {
      ...
      // verify the required parameter 'credentialId' is set
      if (credentialId === undefined || credentialId === null) {
        throw new Error("Missing the required parameter 'credentialId' when calling getCredentialCredentialsCredentialIdGet");
      }
     ...
     * data is of type: {@link module:model/Credential}
     */
    updateCredentialCredentialsCredentialIdPatch(credentialId, credentialUpdate, callback) {
      let postBody = credentialUpdate;
      // verify the required parameter 'credentialId' is set
      if (credentialId === undefined || credentialId === null) {
        throw new Error("Missing the required parameter 'credentialId' when calling updateCredentialCredentialsCredentialIdPatch");
      }
      // verify the required parameter 'credentialUpdate' is set
      if (credentialUpdate === undefined || credentialUpdate === null) {
        throw new Error("Missing the required parameter 'credentialUpdate' when calling updateCredentialCredentialsCredentialIdPatch");
      }
