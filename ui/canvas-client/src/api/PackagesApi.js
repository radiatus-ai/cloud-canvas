...
export default class PackagesApi {
  ...
  createProjectPackageProjectsProjectIdPackagesPost(
    ...
    if (packageCreate === undefined || packageCreate === null) {
      throw new Error(
        "Missing the required parameter 'packageCreate' when calling createProjectPackageProjectsProjectIdPackagesPost"
      );
    }
  ...
  deployProjectPackageProjectsProjectIdPackagesPackageIdDeployPost(
    ...
    if (body === undefined || body === null) {
      throw new Error(
        "Missing the required parameter 'body' when calling deployProjectPackageProjectsProjectIdPackagesPackageIdDeployPost"
      );
    }
  ...
  updateProjectPackageProjectsProjectIdPackagesPackageIdPatch(
    ...
    if (packageUpdate === undefined || packageUpdate === null) {
      throw new Error(
        "Missing the required parameter 'packageUpdate' when calling updateProjectPackageProjectsProjectIdPackagesPackageIdPatch"
      );
    }
