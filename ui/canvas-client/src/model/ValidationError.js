  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('loc')) {
        obj['loc'] = ApiClient.convertToType(data['loc'], [
  ...
  static validateJSON(data) {
    ...
    if (data['loc']) {
      ...
      if (!Array.isArray(data['loc'])) {
        throw new Error(
          'Expected the field `loc` to be an array in the JSON data but got ' +
            data['loc']
        );
      }
    ...
    if (
      data['msg'] &&
      !(typeof data['msg'] === 'string' || data['msg'] instanceof String)
    ) {
      throw new Error(
        'Expected the field `msg` to be a primitive type in the JSON string but got ' +
          data['msg']
      );
    }
    // ensure the json data is a string
