...
class Connection {
     ...
     */
    constructor(sourcePackageId, targetPackageId, sourceHandle, targetHandle, id, projectId) {

        Connection.initialize(this, sourcePackageId, targetPackageId, sourceHandle, targetHandle, id, projectId);
    }
     ...
     */
    static initialize(obj, sourcePackageId, targetPackageId, sourceHandle, targetHandle, id, projectId) {
...
Connection.RequiredProperties = ["source_package_id", "target_package_id", "source_handle", "target_handle", "id", "project_id"];
