...
class CredentialCreate {
   ...
   */
  constructor(credentialType, name, credentialValue) {
    CredentialCreate.initialize(this, credentialType, name, credentialValue);
  }
   ...
   */
  static initialize(obj, credentialType, name, credentialValue) {
